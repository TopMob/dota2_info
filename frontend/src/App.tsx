...
import { LayoutDashboard, History, ShieldCheck, Tv2 } from 'lucide-react'

type Tab = 'live' | 'pip' | 'analytics'
function Dashboard() {
  ...
  const tabs: { id: Tab; label: string; Icon: typeof LayoutDashboard }[] = [{ id: 'live', label: 'live', Icon: LayoutDashboard }, { id: 'pip', label: 'pip', Icon: Tv2 }, { id: 'analytics', label: 'review', Icon: History }]
