...
const translations: Record<Locale, Dictionary> = {
  en: {
    live: 'Live dashboard', pip: 'Streamer mode', review: 'Match review', profile: 'Player profile', debrief: 'Match debrief',
    ...
    valueGpm: '{value} GPM', valueDpm: '{value} DPM', valueDeaths: '{value} deaths', valueCs: '{value} last hits', valueGap: '≈ {value} CS to benchmark', profileTitle: 'Player match history', profileDescription: 'Read-only public match data, transformed into clear coaching signals.', profilePlaceholder: 'Steam ID or profile link', analyzeProfile: 'Analyze', loading: 'Loading…', profileReady: 'Your match history is ready', profilePrivacy: 'Enter a public Steam profile or numeric Steam ID. No Steam login required.', winRate: 'Win rate', totalMatches: 'Total matches', record: 'Record', recentMatches: 'Recent matches', scoreNote: 'Score reflects personal performance, not MMR', rank: 'Rank tier', rankUnavailable: 'Rank unavailable', win: 'Win', loss: 'Loss',
  },
  ru: {
    live: 'Панель матча', pip: 'Режим стримера', review: 'Разбор матча', profile: 'Профиль игрока', debrief: 'Итоги матча',
    ...
    valueGpm: '{value} GPM', valueDpm: '{value} урона/мин', valueDeaths: '{value} смертей', valueCs: '{value} ластхитов', valueGap: '≈ {value} CS до ориентира', profileTitle: 'История матчей игрока', profileDescription: 'Публичные данные матчей, превращённые в понятные тренерские сигналы.', profilePlaceholder: 'Steam ID или ссылка на профиль', analyzeProfile: 'Разобрать', loading: 'Загружаем…', profileReady: 'История матчей готова к разбору', profilePrivacy: 'Введи публичный Steam-профиль или числовой Steam ID. Авторизация Steam не нужна.', winRate: 'Винрейт', totalMatches: 'Всего матчей', record: 'Статистика', recentMatches: 'Последние матчи', scoreNote: 'Оценка отражает личную игру, а не MMR', rank: 'Ранг', rankUnavailable: 'Ранг недоступен', win: 'Победа', loss: 'Поражение',
  },
}
